execute unless score @s price <= @p emerald run tellraw @p ["",{"text":"에메랄드가 부족하다. (필요한 에메랄드 ","color":"white"}, {"nbt":"Item.tag.CustomModelData","entity":"@s","color":"white"}, {"text":"개)","color":"white"}]
