...
#	player = 죽지않은 사람의 수
execute as @a[team=blue] unless score @s out matches 1.. store result score player stage if entity @s
...
#	"ready" 태그 컨트롤
execute as @a[tag=ready] unless entity @s[x=-8,y=50,z=-1008,dx=15,dy=15,dz=15] run tag @s remove ready-end
execute as @a[tag=ready] unless entity @s[x=-8,y=50,z=-1008,dx=15,dy=15,dz=15] run tag @s remove ready
#	"backlobby" 태그 컨트롤
execute as @a[tag=backlobby] if entity @s[x=-8,y=50,z=-1008,dx=15,dy=15,dz=15] run function comm:lobby-comm/ready/showready
execute as @a[tag=backlobby] if entity @s[x=-8,y=50,z=-1008,dx=15,dy=15,dz=15] run tag @s remove backlobby-end
execute as @a[tag=backlobby] if entity @s[x=-8,y=50,z=-1008,dx=15,dy=15,dz=15] run tag @s remove backlobby
#	문을 열려고 하는 사람 수
