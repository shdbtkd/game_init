...
execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~2 71 ~5 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}
execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~-3 71 ~5 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}

execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~5 71 ~2 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}
execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~-6 71 ~2 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}

execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~5 71 ~-3 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}
execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~-6 71 ~-3 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}

execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~2 71 ~-6 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}
execute as @e[tag=active-event,tag=!end-active-event,scores={event-type=1}] at @s run summon minecraft:armor_stand ~-3 71 ~-6 {Tags:["item-random"],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}
