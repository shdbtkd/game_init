# 랜덤 아이템 생성
# execute if entity @e[tag=item-random,scores={item-random=..0}] as @e[tag=item-selecter,tag=basic-item_selector,tag=!load,limit=1,sort=random] run tag @s add load
