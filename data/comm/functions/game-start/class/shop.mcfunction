...
execute if score @s emerald matches 1..64 unless data block ~ 29 ~ Items[{ Slot: 1b, id: "minecraft:emerald", tag:{display:{Name:'{"text":"에메랄드","color":"green","italic":false}'}} }] run replaceitem block ~ 29 ~ container.6 minecraft:emerald{display:{Name:'{"text":"에메랄드","color":"green","italic":false}'}} 1
execute if score @s emerald matches 1..64 store result block ~ 29 ~ Items[{ Slot: 1b, id: "minecraft:emerald", tag:{display:{Name:'{"text":"에메랄드","color":"green","italic":false}'}} }].Count double 1 run scoreboard players get @s emerald
execute if score @s emerald matches 65.. run replaceitem block ~ 29 ~ container.1 minecraft:emerald{display:{Name:'{"text":"에메랄드","color":"green","italic":false}'}} 64
execute if score @s drop-emerald matches 1.. run function comm:game-start/class/remove-emerald
execute if score @s emerald matches 0 run replaceitem block ~ 29 ~ container.1 air
...
execute as @s[scores={emmer=0}] run replaceitem block ~ 29 ~ container.2 air
execute as @s[scores={emmer=1..}] unless data block ~ ~29 ~ Items[{ Slot: 2b, id: "minecraft:arrow", tag:{display:{Name:'{"text":"ammo","color":"light_purple","bold":true,"italic":false}'}, ammo:1b, display_item:1b} }] run replaceitem block ~ 29 ~ container.2 minecraft:arrow{display:{Name:'{"text":"ammo","color":"light_purple","bold":true,"italic":false}'},ammo:1b}
execute as @s[scores={emmer=1..}] store result block ~ 29 ~ Items[{ Slot: 2b, id: "minecraft:arrow", tag:{display:{Name:'{"text":"ammo","color":"light_purple","bold":true,"italic":false}'}, ammo:1b, display_item:1b} }].Count double 1 run scoreboard players get @s emmer
