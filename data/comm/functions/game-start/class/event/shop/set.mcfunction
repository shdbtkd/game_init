...
summon minecraft:item_frame ~ ~ ~ {Tags:["price","price_emerald","price_shop","child-frame"], Facing:2b, Invisible:1b, Fixed:1b }
summon minecraft:item_frame ~ ~ ~ {Tags:["price","price_emerald","price_shop","child-frame"], Facing:3b, Invisible:1b, Fixed:1b }
summon minecraft:item_frame ~ ~ ~ {Tags:["price","price_emerald","price_shop","child-frame"], Facing:4b, Invisible:1b, Fixed:1b }
summon minecraft:item_frame ~ ~ ~ {Tags:["price","price_emerald","price_shop","child-frame"], Facing:5b, Invisible:1b, Fixed:1b }
