...
execute anchored eyes at @s run summon fireball ^ ^ ^1.5 {direction:[0.0,0.0,0.0],power:[0.0,-0.1,0.0],Tags:["rd3sneak-ammo"],ExplosionPower:2,Invulnerable:1b}
...
execute as @e[tag=rd3sneak-ammo,limit=1,sort=nearest] store result entity @s direction[0] double -0.07 run scoreboard players get @a[tag=rd3,limit=1] rd3sneak-motion0
execute as @e[tag=rd3sneak-ammo,limit=1,sort=nearest] run data modify entity @s direction[1] set value 0.7d
execute as @e[tag=rd3sneak-ammo,limit=1,sort=nearest] store result entity @s direction[2] double -0.07 run scoreboard players get @a[tag=rd3,limit=1] rd3sneak-motion2
