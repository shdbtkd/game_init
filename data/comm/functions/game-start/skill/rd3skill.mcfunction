execute if score @s mine-c matches ..0 if score @s mine-p matches ..0 if score @s rd3-emmer-remove matches 1.. run function comm:game-start/skill/attack/rd3
execute if score @s mine-c matches 1.. if score @s mine-p matches 1.. if score @s rd3-emmer-remove matches 1.. run scoreboard players set @s rd3-emmer-remove 0
