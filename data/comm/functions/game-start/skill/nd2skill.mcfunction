...
execute if score @s mine-c matches 1.. if score @s nd2-emmer-remove matches 1.. run scoreboard players set @s nd2-emmer-remove 0
execute if score @s mine-p matches 1.. if score @s nd2-emmer-remove matches 1.. run scoreboard players set @s nd2-emmer-remove 0
execute if score @s mine-c matches ..0 if score @s mine-p matches ..0 if entity @s[scores={nd2-emmer-remove=1..}] run function comm:game-start/skill/attack/nd2
