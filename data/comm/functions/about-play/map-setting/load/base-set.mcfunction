...
execute if score @p stage matches 6 as @s[tag=center] run function comm:about-play/map-setting/load/type/overworld/overworld_center
execute if score @p stage matches 6 as @s[tag=map-all,tag=!boss] if block ~ ~-1 ~48 #minecraft:road_tracking run setblock ~-16 61 ~16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,posX:31,rotation:"CLOCKWISE_90",mode:"LOAD"}
execute if score @p stage matches 6 as @s[tag=map-all,tag=!boss] if block ~48 ~-1 ~ #minecraft:road_tracking run setblock ~16 61 ~-16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,mode:"LOAD"}

execute if score @p stage matches 7 as @s[tag=center] run function comm:about-play/map-setting/load/type/overworld/overworld_center
execute if score @p stage matches 7 as @s[tag=map-all,tag=!boss] if block ~ ~-1 ~48 #minecraft:road_tracking run setblock ~-16 61 ~16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,posX:31,rotation:"CLOCKWISE_90",mode:"LOAD"}
execute if score @p stage matches 7 as @s[tag=map-all,tag=!boss] if block ~48 ~-1 ~ #minecraft:road_tracking run setblock ~16 61 ~-16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,mode:"LOAD"}

execute if score @p stage matches 8 as @s[tag=center] run function comm:about-play/map-setting/load/type/overworld/overworld_center
execute if score @p stage matches 8 as @s[tag=map-all,tag=!boss] if block ~ ~-1 ~48 #minecraft:road_tracking run setblock ~-16 61 ~16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,posX:31,rotation:"CLOCKWISE_90",mode:"LOAD"}
execute if score @p stage matches 8 as @s[tag=map-all,tag=!boss] if block ~48 ~-1 ~ #minecraft:road_tracking run setblock ~16 61 ~-16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,mode:"LOAD"}

execute if score @p stage matches 9 as @s[tag=center] run function comm:about-play/map-setting/load/type/overworld/overworld_center
execute if score @p stage matches 9 as @s[tag=map-all,tag=!boss] if block ~ ~-1 ~48 #minecraft:road_tracking run setblock ~-16 61 ~16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,posX:31,rotation:"CLOCKWISE_90",mode:"LOAD"}
execute if score @p stage matches 9 as @s[tag=map-all,tag=!boss] if block ~48 ~-1 ~ #minecraft:road_tracking run setblock ~16 61 ~-16 minecraft:structure_block{name:"overworld:overworld-road",posY:1,mode:"LOAD"}
...
execute as @s[tag=map-all,tag=!boss] if block ~ ~-1 ~48 #minecraft:road_tracking run setblock ~-16 62 ~16 minecraft:redstone_block destroy
execute as @s[tag=map-all,tag=!boss] if block ~48 ~-1 ~ #minecraft:road_tracking run setblock ~16 62 ~-16 minecraft:redstone_block destroy
