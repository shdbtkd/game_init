...
execute if score count-event map_lod < min-event map_lod as @e[tag=map-all,scores={stage-road_count=..3},sort=random,limit=1] at @s run function comm:about-play/map-setting/load/stage/sub_road
