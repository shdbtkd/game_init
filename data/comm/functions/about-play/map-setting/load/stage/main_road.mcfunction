...
execute if score count-loader map_lod < min-battle map_lod at @e[tag=center] as @e[tag=tester,sort=furthest,limit=1] at @s if predicate pred:50 run function comm:about-play/map-setting/load/stage/summon_loader
execute if score count-loader map_lod < min-battle map_lod at @e[tag=center] as @e[tag=tester,sort=furthest,limit=1] at @s if predicate pred:loot run function comm:about-play/map-setting/load/stage/summon_loader
