### hotbar ###
    ...
    execute as @s[scores={inven_tab-type=1}] run loot replace block ~ 21 ~ container.7 mine ~ 17 ~ stick{drop_contents:true}
    execute as @s[scores={inven_tab-type=2}] run loot replace block ~ 21 ~ container.7 mine ~ 12 ~ stick{drop_contents:true}
    execute as @s[scores={inven_tab-type=3}] run loot replace block ~ 21 ~ container.7 mine ~ 19 ~ stick{drop_contents:true}
