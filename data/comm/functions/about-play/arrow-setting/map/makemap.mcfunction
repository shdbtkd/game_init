...
### top ###
    ...
    execute at @e[tag=testmap,tag=testtop] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.4 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}
    ...
    execute at @e[tag=testmap,tag=testtop] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.4 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testtop] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.4 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}
    ...
    execute at @e[tag=testmap,tag=testtop] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.4 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### top-left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testtopleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.3 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testtopleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.3 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testtopleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.3 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testtopleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.3 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### top-left-left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testtopleftleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.2 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testtopleftleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.2 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testtopleftleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.2 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testtopleftleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.2 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### top-right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testtopright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.5 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testtopright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.5 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testtopright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.5 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testtopright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.5 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### top-right-right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testtoprightright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.6 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testtoprightright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.6 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testtoprightright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.6 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testtoprightright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.6 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### bottom ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testbottom] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.22 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testbottom] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.22 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testbottom] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.22 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testbottom] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.22 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### bottom-left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testbottomleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.21 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testbottomleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.21 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testbottomleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.21 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testbottomleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.21 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### bottom-left-left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testbottomleftleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.20 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testbottomleftleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.20 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testbottomleftleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.20 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testbottomleftleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.20 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### bottom-right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testbottomright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.23 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testbottomright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.23 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testbottomright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.23 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testbottomright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.23 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### bottom-right-right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testbottomrightright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.24 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testbottomrightright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.24 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testbottomrightright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.24 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testbottomrightright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.24 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.12 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.12 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.12 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.12 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### left-left ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testleftleft] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.11 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testleftleft] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.11 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testleftleft] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.11 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testleftleft] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.11 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.14 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.14 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.14 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.14 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
...
### right-right ###
    ...
    #---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ---------- chestevent ----------
    execute at @e[tag=testmap,tag=testrightright] if entity @e[distance=..1,tag=map-all,tag=chest-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.15 minecraft:yellow_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ---------- shopevent ----------
    execute at @e[tag=testmap,tag=testrightright] if entity @e[distance=..1,tag=map-all,tag=shop-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.15 minecraft:lime_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ---------- enchant ----------
    execute at @e[tag=testmap,tag=testrightright] if entity @e[distance=..1,tag=map-all,tag=enchan-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.15 minecraft:magenta_stained_glass_pane{display:{Name:'{"text":" "}'}}

    #---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ---------- boss event ----------
    execute at @e[tag=testmap,tag=testrightright] if entity @e[distance=..1,tag=map-all,tag=boss-event] at @e[tag=modify-head] if score @e[distance=..0,limit=1,sort=nearest] class-index = @s class-index run replaceitem block ~ 17 ~ container.15 minecraft:pink_stained_glass_pane{display:{Name:'{"text":" "}'}}
