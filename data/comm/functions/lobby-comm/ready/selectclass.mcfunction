...
#nd1
    ...
    execute at @e[tag=n-d-1] as @a[tag=!nd1,distance=..0.7] unless entity @a[tag=nd1] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
...
#rd1
    ...
    execute at @e[tag=r-d-1] as @a[tag=!rd1,distance=..0.7] unless entity @a[tag=rd1] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
...
#nd2
    ...
    execute at @e[tag=n-d-2] as @a[tag=!nd2,distance=..0.7] unless entity @a[tag=nd2] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
...
#rd2
    ...
    execute at @e[tag=r-d-2] as @a[tag=!rd2,distance=..0.7] unless entity @a[tag=rd2] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
...
#nd3
    ...
    execute at @e[tag=n-d-3] as @a[tag=!nd3,distance=..0.7] unless entity @a[tag=nd3] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
...
#rd3
    ...
    execute at @e[tag=r-d-3] as @a[tag=!rd3,distance=..0.7] unless entity @a[tag=rd3] run playsound minecraft:entity.arrow.hit_player player @s ~ ~ ~ 0.5 0
